                                         ...
                                         @if (quote) {
                                            <div class="bg-slate-50 dark:bg-slate-950 p-3 rounded-lg border border-slate-100 dark:border-slate-800 relative z-10" [class.border-emerald-500]="req.acceptedQuoteId === quote.id">
                                               ...
                                               @if (req.recommendedQuoteIds?.includes(quote.id)) {
                                                  <div class="flex items-center gap-1 mb-2 px-2 py-1 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800/50 rounded-full w-fit">
                                                     ...
                                                     <span class="text-[9px] font-bold text-amber-600 dark:text-amber-400">Recommandé par Mécatech</span>
                                                  </div>
                                               }
